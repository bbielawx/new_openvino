.. index:: pair: page; Install OpenVINO™ Runtime on Linux
...
:target:`doxid-openvino_docs_install_guides_installing_openvino_linux_header_1md_openvino_docs_articles_en_get_started_installing_openvino_overview_installing_openvino_linux_header`
